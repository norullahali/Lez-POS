...
class _BackupScreenState extends ConsumerState<BackupScreen> {
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text('سجل عمليات النسخ الاحتياطي',
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      color: AppColors.textPrimary)),
                        ...
                        Expanded(
                          child: recentLogs.when(
                            ...
                            error: (e, _) =>
                                Center(child: Text('خطأ في تحميل السجل: $e')),
                            data: (logs) {
                              if (logs.isEmpty) {
                                return const Center(
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return ListTile(
                                    ...
                                    title: Text(log.details ?? log.actionType,
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('تم أخذ النسخة الاحتياطية بنجاح!'),
  ...
  Future<void> _restoreBackup() async {
    ...
    final backups =
        await ref.read(backupSettingsProvider.notifier).getExistingBackups();
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: backups.isEmpty
              ? const Center(
                  child: Text('لا توجد نسخ احتياطية في المجلد الافتراضي.'))
              : ListView.builder(
    ...
    try {
      await ref
          ...
          .restoreFromBackup(selectedFile);
      if (mounted) {
        await showDialog(
          context: context,
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text(
                'تم استعادة البيانات بنجاح. سيتم إغلاق التطبيق الآن، يرجى إعادة تشغيله يدوياً.'),
            actions: [
              ElevatedButton(
                onPressed: () => exit(0),
