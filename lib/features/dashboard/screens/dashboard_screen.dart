                      ...
                      : _AlertCard(
                          ...
                          children: items
                              ...
                              .map((item) => _AlertItem(
                                    ...
                                    detail:
                                        'المتبقي: ${(item['current_stock'] as num?)?.toStringAsFixed(1) ?? '0'}',
                                  ))
                              .toList(),
                        ),
                ),
                  ...
                  data: (items) => items.isEmpty
                      ...
                      : _AlertCard(
                          ...
                          children: items.take(5).map((item) {
                            ...
                            final days =
                                expiry?.difference(DateTime.now()).inDays ?? 0;
                            return _AlertItem(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Text('لا توجد مبيعات اليوم بعد',
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(children: [
                            ...
                            Text('أكثر المنتجات مبيعاً اليوم',
                        ...
                        ...products.take(10).toList().asMap().entries.map((e) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                                '${nfInt.format(p['total_qty'] ?? 0)} وحدة مباعة'),
                            trailing: Text('${nfInt.format(revenue)} د.ع',
                                style: const TextStyle(
                                    color: AppColors.primary,
                                    fontWeight: FontWeight.w700)),
                          );
