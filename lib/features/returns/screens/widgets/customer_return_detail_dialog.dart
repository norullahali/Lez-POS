...
import '../../providers/customer_return_detail_provider.dart';

Future<void> showCustomerReturnDetailDialog(
  ...
  return showDialog<void>(
    context: context,
    builder: (_) => CustomerReturnDetailDialog(returnId: returnId),
  );
}

class CustomerReturnDetailDialog extends ConsumerWidget {
  const CustomerReturnDetailDialog({super.key, required this.returnId});

  final int returnId;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final detailAsync = ref.watch(customerReturnDetailProvider(returnId));
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      _MetaChip(
                          label: 'العميل', value: detail.displayCustomerName),
                      _MetaChip(
                          label: 'فاتورة البيع',
                          value: detail.displaySaleInvoice),
                      _MetaChip(
                          label: 'التاريخ',
                      ...
                      child: DataTable(
                        ...
                        rows: detail.lines.map((line) {
                          return DataRow(cells: [
                            ...
                            DataCell(Text(moneyFmt.format(line.unitPrice))),
                ...
                if (detail.isRefundLinkEligible)
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        detail.isInvoiceLinked
                            ? 'لا يمكن ربط هذا المرتجع باسترداد نقدي للعميل'
                            : 'لا يمكن ربط هذا المرتجع باسترداد نقدي للعميل لعدم وجود فاتورة أصلية',
